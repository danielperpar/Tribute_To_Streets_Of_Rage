...
bool ModuleEnemies::Start()
{
	...
	m_garcia1->m_ai_controller.m_player = App->player->player;
	...
	grab_collider_garcia1->SetPos(m_garcia1->position.x + m_garcia1->m_x_ref - grab_collider_garcia1->m_rect.w / 2, m_garcia1->depth);
	...
	hit_collider_garcia1->SetPos(m_garcia1->position.x + m_garcia1->m_x_ref - hit_collider_garcia1->m_rect.w / 2, m_garcia1->depth);
...
update_status ModuleEnemies::Update()
{
	...
	//			{
	//				if (!strcmp(enemy->name, "garcia"))
	//				{
	//					Garcia *garcia = (Garcia*)enemy;

	//					if (garcia->m_punch_hits < 2)
	//					{
	//						if (App->player->m_player_collider->CheckCollision(garcia->m_enemy_hit_collider->m_rect) == true && garcia->depth == m_player->depth)
	//						{
	...
	//					
	//				}
	//				if (!strcmp(enemy->name, "garcia_knife"))
	//				{
	//					GarciaKnife *garcia_knife = (GarciaKnife*)enemy;
	//					if (garcia_knife->m_allow_attack)
	//					{
	//						if (App->player->m_player_collider->CheckCollision(garcia_knife->m_enemy_hit_collider->m_rect) == true && garcia_knife->depth == m_player->depth)
	//						{
	...
	//					}
	//				}
	//				if (!strcmp(enemy->name, "punky"))
	//				{
	//					Punky *punky = (Punky*)enemy;
	//					if (punky->m_allow_attack)
	//					{
	//						if (App->player->m_player_collider->CheckCollision(punky->m_enemy_hit_collider->m_rect) == true && punky->depth == m_player->depth)
	//						{
	...
	//					}
	//				}
	//				if (!strcmp(enemy->name, "nora"))
	//				{
	//					Nora *nora = (Nora*)enemy;

	//					if (nora->m_allow_attack)
	//					{
	//						if (App->player->m_player_collider->CheckCollision(nora->m_enemy_hit_collider->m_rect) == true && nora->depth == m_player->depth)
	//						{
	...
	//					{
	//						if (App->player->m_player_collider->CheckCollision(antonio->m_enemy_hit_collider->m_rect) == true && antonio->depth + antonio->m_y_ref == m_player->depth)
	//						{
	...
	//			{
	//				punky->position.x += punky->m_ground_attack_speed;
	//				UpdateColliderPosition(punky);
	//				punky->m_timer_count++;

	//				//move grab collider to the feet
	//				punky->m_enemy_grab_collider->SetPos((punky->position.x + punky->m_x_ref - punky->m_enemy_grab_collider->m_rect.w / 2) + 50, punky->depth);
	...
	//				nora->m_enemy_grab_collider->SetPos((nora->position.x + nora->m_x_ref - nora->m_enemy_grab_collider->m_rect.w / 2) + 45, nora->depth);
	//				
	...
	//	if ((*it)->type == entity_type::ENEMY)
	//	{
	//		App->renderer->Blit((*it)->texture, (*it)->position.x, (*it)->position.y, &(((Enemy*)(*it))->m_current_animation->GetCurrentFrame()));
	//	}
	//}
...
void ModuleEnemies::UpdateColliderPosition(Enemy* enemy)
{
	...
	if (strcmp(enemy->name, "antonio"))
	{
		enemy->m_enemy_grab_collider->SetPos(enemy->position.x + enemy->m_x_ref - enemy->m_enemy_grab_collider->m_rect.w / 2, enemy->depth);
		enemy->m_enemy_hit_collider->SetPos(enemy->position.x + enemy->m_x_ref - enemy->m_enemy_hit_collider->m_rect.w / 2, enemy->depth);
		
	}
	//boss anntonio
	if (!strcmp(enemy->name, "antonio"))
	{
		enemy->m_enemy_grab_collider->SetPos(enemy->position.x + enemy->m_x_ref - enemy->m_enemy_grab_collider->m_rect.w / 2, enemy->depth + enemy->m_y_ref);
		enemy->m_enemy_hit_collider->SetPos(enemy->position.x + enemy->m_x_ref - enemy->m_enemy_hit_collider->m_rect.w / 2, enemy->depth + enemy->m_y_ref);
