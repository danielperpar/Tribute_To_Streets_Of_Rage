...
public:
	...
	static int GetInt(const char *json_file, const char *entity_name, const char *property_name);
	static float GetFloat(const char *json_file, const char *entity_name, const char *property_name);
